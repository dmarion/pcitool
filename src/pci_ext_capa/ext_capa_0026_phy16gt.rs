...
capabilities! {
    {
        ...
        registers: [
            ...
            },
            {
                ...
                offset: 0x10,
                id: LOCAL_DATA_PARITY_MISMATCH_STAT,
                size: Dword,
                fields: []
            },
            {
                ...
                offset: 0x14,
                id: FIRST_RETIMER_DATA_PARITY_MISMATCH_STAT,
                size: Dword,
                fields: []
            },
            {
                ...
                offset: 0x18,
                id: SECOND_RETIMER_DATA_PARITY_MISMATCH_STAT,
                size: Dword,
                fields: []
            },
            {
...
fn summary(cap: &PciCapa) -> Option<Vec<TreeNode>> {
    ...
    Some(vec![TreeNode::with_value(
        TreeLine::from("Physical Layer 16.0 GT/s"),
        TreeLine::from(spans),
    )])
}
